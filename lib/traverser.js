...
function traverser(args) {
        ...
        return {
            ...
            enterScope: function (node) {
                ...
                scope.ctemp = function () {
                    return __this.ast.ctemp;
                };
                scope.temp = function () {
                    return '__t' + __this.ast.ctemp++;
                };
    ...
    me.blockStmts = function (stmts, context) {
        return flatten(stmts.map(function (stmt) {
            return me.blockStmt(stmt, context);
        }));
    };
    ...
    me.blockStmt = function (stmt, context) {
        return me.stmt(stmt, context);
    };
    me.block = function (stmt, context) {
        return context.block(stmt, context.stmts[1], function (context) {
    ...
    me.expr = function (expr, context) {
        ...
        case 'SequenceExpression':
            expr.expressions = expr.expressions.map(function (x) {
                return me.expr(x, context);
            });
            return expr;
