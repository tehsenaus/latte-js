var __this = this;
var esprima = require('../lib/esprima-latte'), escodegen = require('escodegen'), transform = require('../lib/transform'), es = require('event-stream'), fs = require('fs'), path = require('path'), glob = require('glob'), util = require('util');
