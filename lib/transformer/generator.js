...
var generatorTransformer = module.exports = traverser.explicit('generator', {
        ...
        whileDoWhileStmt: function (stmt, context) {
            if (context.generator && stmtHasYields(stmt.body)) {
                ...
                stmt.calleeFn.generator = true;
                stmt.calleeFn.internalGenerator = context.generator;
        ...
        callExpr: function (expr, context) {
            var __this = this;
            if (expr.calleeFn && expr.calleeFn.generator && expr.calleeFn.internalGenerator && expr.calleeFn.body.body[0].type == 'ReturnStatement') {
                var m = expr.calleeFn;
                return m.internalGenerator.withcc(function (cc) {
                    m.body = cc(m.body.body[0].argument);
        ...
        stmt: function (stmt, context) {
            ...
            if (stmt.type == 'ExpressionStatement') {
                ...
                if (stmt.expression.type == 'CallExpression' && stmt.expression.calleeFn && stmt.expression.calleeFn.generator && stmt.expression.calleeFn.internalGenerator) {
                    var m = stmt.expression.calleeFn;
